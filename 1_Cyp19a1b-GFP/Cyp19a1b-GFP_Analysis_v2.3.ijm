//	Cyp19a1b-GFP_Analysis - Cyril TURIÈS - any comment/improvement is welcome (mailto: cyril.turies@ineris.fr)
...
// 	- Group all pixels above the threshold in one Region Of Interest and save this ROI in a zip file with the name than the image
...
//	- 10/2014 CSV saving option in current directory
...
// DialogBox Help message
  help = "<html>"
	+"<h2><u>Cyp19a1b-GFP Analysis help</u></h2>"
	...
	+"ZVI (Zeiss Vision Image) and TIFF (Tagged Image File Format).<br><br>"
	...
	+"<b>Measure ROIs</b> : Step 2 of image analysis to check individually<br>and measure previously created ROIs.<br><br>"
	...
	+"<b>Silent Mode</b> : if selected, the macro will measure all images with their<br>associated ROI without prompting the user many times.<br><br>"
	+"<b>Restart Mode</b> : when auto processing is cancelled accidentally,<br>this mode checks whether or not a ROI was created then creates one if needed<br><br>"
...
// DialogBox to set options
	Dialog.create("Cyp19b-GFP "+v+" options");
